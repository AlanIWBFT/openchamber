...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.liveActivity.runningCommands': 'Comandos em execução: {count}',
  ...
  'startup.launching': 'Iniciando o OpenChamber',
  'startup.migrating': 'Atualizando o banco de dados',
  'startup.finalizing': 'Migração concluída, aguardando o OpenCode ficar pronto',
  'startup.migrationDetail': 'Isso pode levar alguns minutos. Mantenha o OpenChamber aberto.',
  'startup.failed': 'Não foi possível iniciar o OpenChamber',
  'startup.restartDetail': 'Reinicie o OpenChamber para tentar novamente.',
  ...
  "chat.activity.exploration": "Exploração",
  "chat.activity.exploration.summary.searchesAndReads": "Pesquisas: {searchCount} · Leituras: {readCount}",
  "chat.activity.exploration.summary.searches": "Pesquisas: {searchCount}",
  "chat.activity.exploration.summary.reads": "Leituras: {readCount}",
  ...
  "chat.toolPart.readDirectory": "Ler diretório",
  ...
  "chat.toolPart.unifiedExec.status.running": "Em execução",
  "chat.toolPart.unifiedExec.status.runningWithDuration": "Em execução há {duration}",
  "chat.toolPart.unifiedExec.status.terminated": "Encerrado",
  "chat.toolPart.unifiedExec.status.terminatedWithDuration": "Encerrado · {duration}",
  "chat.toolPart.unifiedExec.status.exited": "Saiu com o código {code}",
  "chat.toolPart.unifiedExec.status.exitedWithDuration": "Saiu com o código {code} · {duration}",
  "chat.toolPart.unifiedExec.status.completed": "Concluído",
  "chat.toolPart.unifiedExec.status.completedWithDuration": "Concluído em {duration}",
  "chat.toolPart.unifiedExec.outputTruncated": "A saída anterior foi omitida",
  "chat.toolPart.unifiedExec.outputStreamError": "Erro no fluxo de saída: {error}",
  "chat.assistantStatus.unifiedExec.runningCommand": "executando comando",
  "chat.assistantStatus.unifiedExec.preparingProcessOperation": "preparando a operação do processo",
  "chat.assistantStatus.unifiedExec.pollingProcessOutput": "consultando a saída do processo",
  "chat.assistantStatus.unifiedExec.sendingProcessInput": "enviando entrada ao processo",
  "chat.assistantStatus.unifiedExec.terminatingProcess": "encerrando processo",
  "chat.providerError.rateLimited": "Este modelo está com limite de taxa. O OpenCode tentará novamente quando houver capacidade.",
  "chat.providerError.usageLimited": "Você atingiu o limite de uso deste modelo. Selecione outro modelo para continuar.",
  "chat.providerError.planNotIncluded": "Seu plano atual não inclui este modelo. Selecione outro modelo ou faça upgrade do plano.",
  "chat.providerError.quotaExceeded": "A cota foi excedida. Verifique seu plano e faturamento.",
  "chat.providerError.policyBlocked": "Esta solicitação foi bloqueada por uma política de segurança. Altere-a e tente novamente.",
  "chat.providerError.authentication": "A autenticação falhou. Entre novamente ou verifique as credenciais do provedor.",
  "chat.providerError.invalidInput": "Não foi possível processar esta solicitação. Ajuste-a e tente novamente.",
  "chat.providerError.network": "A solicitação ao provedor foi bloqueada pela rede ou pela região. Verifique sua conexão e o acesso ao provedor.",
  "chat.providerError.server": "O provedor está temporariamente indisponível. O OpenCode tentará novamente automaticamente.",
};
