...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.liveActivity.runningCommands': 'Comandos en ejecución: {count}',
  ...
  'startup.launching': 'Iniciando OpenChamber',
  'startup.migrating': 'Actualizando la base de datos',
  'startup.finalizing': 'Migración completada, esperando a que OpenCode esté listo',
  'startup.migrationDetail': 'Esto puede tardar varios minutos. Mantén OpenChamber abierto.',
  'startup.failed': 'No se pudo iniciar OpenChamber',
  'startup.restartDetail': 'Reinicia OpenChamber para volver a intentarlo.',
  ...
  "chat.activity.exploration": "Exploración",
  "chat.activity.exploration.summary.searchesAndReads": "Búsquedas: {searchCount} · Lecturas: {readCount}",
  "chat.activity.exploration.summary.searches": "Búsquedas: {searchCount}",
  "chat.activity.exploration.summary.reads": "Lecturas: {readCount}",
  ...
  "chat.toolPart.readDirectory": "Leer directorio",
  ...
  "chat.toolPart.unifiedExec.status.running": "En ejecución",
  "chat.toolPart.unifiedExec.status.runningWithDuration": "En ejecución durante {duration}",
  "chat.toolPart.unifiedExec.status.terminated": "Terminado",
  "chat.toolPart.unifiedExec.status.terminatedWithDuration": "Terminado · {duration}",
  "chat.toolPart.unifiedExec.status.exited": "Finalizó con el código {code}",
  "chat.toolPart.unifiedExec.status.exitedWithDuration": "Finalizó con el código {code} · {duration}",
  "chat.toolPart.unifiedExec.status.completed": "Completado",
  "chat.toolPart.unifiedExec.status.completedWithDuration": "Completado en {duration}",
  "chat.toolPart.unifiedExec.outputTruncated": "Se omitió la salida anterior",
  "chat.toolPart.unifiedExec.outputStreamError": "Error del flujo de salida: {error}",
  "chat.assistantStatus.unifiedExec.runningCommand": "ejecutando comando",
  "chat.assistantStatus.unifiedExec.preparingProcessOperation": "preparando la operación del proceso",
