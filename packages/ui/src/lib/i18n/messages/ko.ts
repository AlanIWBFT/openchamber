...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.liveActivity.runningCommands': '실행 중인 명령: {count}',
  ...
  'startup.launching': 'OpenChamber 시작 중',
  'startup.migrating': '데이터베이스 업그레이드 중',
  'startup.finalizing': '마이그레이션 완료, OpenCode가 준비될 때까지 기다리는 중',
  'startup.migrationDetail': '몇 분 정도 걸릴 수 있습니다. OpenChamber를 열어 두세요.',
  'startup.failed': 'OpenChamber를 시작할 수 없습니다',
  'startup.restartDetail': 'OpenChamber를 다시 시작한 후 재시도하세요.',
  ...
  'chat.activity.exploration': '탐색',
  'chat.activity.exploration.summary.searchesAndReads': '검색 {searchCount}회 · 읽기 {readCount}회',
  'chat.activity.exploration.summary.searches': '검색 {searchCount}회',
  'chat.activity.exploration.summary.reads': '읽기 {readCount}회',
  ...
  'chat.toolPart.readDirectory': '디렉터리 읽기',
  ...
  'chat.toolPart.unifiedExec.status.running': '실행 중',
  'chat.toolPart.unifiedExec.status.runningWithDuration': '{duration} 동안 실행 중',
  'chat.toolPart.unifiedExec.status.terminated': '종료됨',
  'chat.toolPart.unifiedExec.status.terminatedWithDuration': '종료됨 · {duration}',
  'chat.toolPart.unifiedExec.status.exited': '종료 코드: {code}',
  'chat.toolPart.unifiedExec.status.exitedWithDuration': '종료 코드: {code} · {duration}',
  'chat.toolPart.unifiedExec.status.completed': '완료',
  'chat.toolPart.unifiedExec.status.completedWithDuration': '{duration} 만에 완료',
  'chat.toolPart.unifiedExec.outputTruncated': '이전 출력이 생략됨',
  'chat.toolPart.unifiedExec.outputStreamError': '출력 스트림 오류: {error}',
  'chat.assistantStatus.unifiedExec.runningCommand': '명령 실행 중',
  'chat.assistantStatus.unifiedExec.preparingProcessOperation': '프로세스 작업 준비 중',
