...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.liveActivity.runningCommands': '正在執行的命令：{count}',
  ...
  'startup.launching': '正在啟動 OpenChamber',
  'startup.migrating': '正在升級資料庫',
  'startup.finalizing': '遷移完成，正在等待 OpenCode 就緒',
  'startup.migrationDetail': '這可能需要幾分鐘，請保持 OpenChamber 開啟。',
  'startup.failed': 'OpenChamber 啟動失敗',
  'startup.restartDetail': '請重新啟動 OpenChamber 後再試。',
  ...
  'chat.activity.exploration.summary.searchesAndReads': '{searchCount} 次搜尋 · {readCount} 次讀取',
  'chat.activity.exploration.summary.searches': '{searchCount} 次搜尋',
  'chat.activity.exploration.summary.reads': '{readCount} 次讀取',
  ...
  'chat.toolPart.readDirectory': '讀取目錄',
  ...
  'chat.reasoningTrace.justification': '推理',
  ...
  'chat.toolPart.unifiedExec.status.running': '執行中',
  'chat.toolPart.unifiedExec.status.runningWithDuration': '已執行 {duration}',
  'chat.toolPart.unifiedExec.status.terminated': '已終止',
  'chat.toolPart.unifiedExec.status.terminatedWithDuration': '已終止 · {duration}',
  'chat.toolPart.unifiedExec.status.exited': '已結束，代碼 {code}',
  'chat.toolPart.unifiedExec.status.exitedWithDuration': '已結束，代碼 {code} · {duration}',
  'chat.toolPart.unifiedExec.status.completed': '已完成',
  'chat.toolPart.unifiedExec.status.completedWithDuration': '已完成 · {duration}',
  'chat.toolPart.unifiedExec.outputTruncated': '已省略較早的輸出',
  'chat.toolPart.unifiedExec.outputStreamError': '輸出串流錯誤：{error}',
  'chat.assistantStatus.unifiedExec.runningCommand': '正在執行命令',
  'chat.assistantStatus.unifiedExec.preparingProcessOperation': '正在準備程序操作',
