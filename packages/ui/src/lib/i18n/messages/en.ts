...
export const dict = {
  ...
  'chat.liveActivity.runningCommands': 'Commands running: {count}',
  ...
  'startup.launching': 'Starting OpenChamber',
  'startup.migrating': 'Upgrading the database',
  'startup.finalizing': 'Migration complete, waiting for OpenCode to be ready',
  'startup.migrationDetail': 'This may take several minutes. Keep OpenChamber open.',
  'startup.failed': 'OpenChamber could not start',
  'startup.restartDetail': 'Restart OpenChamber to try again.',
  ...
  'chat.activity.exploration.summary.searchesAndReads': 'Search: {searchCount} · Read: {readCount}',
  'chat.activity.exploration.summary.searches': 'Search: {searchCount}',
  'chat.activity.exploration.summary.reads': 'Read: {readCount}',
  ...
  'chat.toolPart.readDirectory': 'Read Directory',
  ...
  'chat.toolPart.unifiedExec.status.running': 'Running',
  'chat.toolPart.unifiedExec.status.runningWithDuration': 'Running {duration}',
  'chat.toolPart.unifiedExec.status.terminated': 'Terminated',
  'chat.toolPart.unifiedExec.status.terminatedWithDuration': 'Terminated · {duration}',
  'chat.toolPart.unifiedExec.status.exited': 'Exited {code}',
  'chat.toolPart.unifiedExec.status.exitedWithDuration': 'Exited {code} · {duration}',
  'chat.toolPart.unifiedExec.status.completed': 'Completed',
  'chat.toolPart.unifiedExec.status.completedWithDuration': 'Completed {duration}',
  'chat.toolPart.unifiedExec.outputTruncated': 'Earlier output omitted',
  'chat.toolPart.unifiedExec.outputStreamError': 'Output stream error: {error}',
  'chat.assistantStatus.unifiedExec.runningCommand': 'running command',
  'chat.assistantStatus.unifiedExec.preparingProcessOperation': 'preparing process operation',
