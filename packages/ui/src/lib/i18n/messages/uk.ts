...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.liveActivity.runningCommands': 'Команди, що виконуються: {count}',
  ...
  'startup.launching': 'Запуск OpenChamber',
  'startup.migrating': 'Оновлення бази даних',
  'startup.finalizing': 'Міграцію завершено, очікуємо готовності OpenCode',
  'startup.migrationDetail': 'Це може тривати кілька хвилин. Не закривайте OpenChamber.',
  'startup.failed': 'Не вдалося запустити OpenChamber',
  'startup.restartDetail': 'Перезапустіть OpenChamber, щоб спробувати ще раз.',
  ...
  "chat.activity.exploration": "Дослідження",
  "chat.activity.exploration.summary.searchesAndReads": "Пошуки: {searchCount} · Читання: {readCount}",
  "chat.activity.exploration.summary.searches": "Пошуки: {searchCount}",
  "chat.activity.exploration.summary.reads": "Читання: {readCount}",
  ...
  "chat.toolPart.readDirectory": "Прочитати каталог",
  ...
  "chat.toolPart.unifiedExec.status.running": "Виконується",
  "chat.toolPart.unifiedExec.status.runningWithDuration": "Виконується {duration}",
  "chat.toolPart.unifiedExec.status.terminated": "Зупинено",
  "chat.toolPart.unifiedExec.status.terminatedWithDuration": "Зупинено · {duration}",
  "chat.toolPart.unifiedExec.status.exited": "Процес завершився з кодом {code}",
  "chat.toolPart.unifiedExec.status.exitedWithDuration": "Процес завершився з кодом {code} · {duration}",
  "chat.toolPart.unifiedExec.status.completed": "Завершено",
  "chat.toolPart.unifiedExec.status.completedWithDuration": "Завершено за {duration}",
  "chat.toolPart.unifiedExec.outputTruncated": "Попередній вивід пропущено",
  "chat.toolPart.unifiedExec.outputStreamError": "Помилка потоку виводу: {error}",
  "chat.assistantStatus.unifiedExec.runningCommand": "виконання команди",
  "chat.assistantStatus.unifiedExec.preparingProcessOperation": "підготовка операції процесу",
