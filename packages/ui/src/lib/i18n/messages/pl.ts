...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.liveActivity.runningCommands': 'Uruchomione polecenia: {count}',
  ...
  'startup.launching': 'Uruchamianie OpenChamber',
  'startup.migrating': 'Aktualizowanie bazy danych',
  'startup.finalizing': 'Migracja zakończona, oczekiwanie na gotowość OpenCode',
  'startup.migrationDetail': 'Może to potrwać kilka minut. Nie zamykaj OpenChamber.',
  'startup.failed': 'Nie udało się uruchomić OpenChamber',
  'startup.restartDetail': 'Uruchom ponownie OpenChamber, aby spróbować jeszcze raz.',
  ...
  'chat.activity.exploration': 'Eksploracja',
  'chat.activity.exploration.summary.searchesAndReads': 'Wyszukiwania: {searchCount} · Odczyty: {readCount}',
  'chat.activity.exploration.summary.searches': 'Wyszukiwania: {searchCount}',
  'chat.activity.exploration.summary.reads': 'Odczyty: {readCount}',
  ...
  'chat.toolPart.readDirectory': 'Odczytaj katalog',
  ...
  'chat.toolPart.unifiedExec.status.running': 'W toku',
  'chat.toolPart.unifiedExec.status.runningWithDuration': 'W toku od {duration}',
  'chat.toolPart.unifiedExec.status.terminated': 'Przerwano',
  'chat.toolPart.unifiedExec.status.terminatedWithDuration': 'Przerwano · {duration}',
  'chat.toolPart.unifiedExec.status.exited': 'Proces zakończył się kodem {code}',
  'chat.toolPart.unifiedExec.status.exitedWithDuration': 'Proces zakończył się kodem {code} · {duration}',
  'chat.toolPart.unifiedExec.status.completed': 'Ukończono',
  'chat.toolPart.unifiedExec.status.completedWithDuration': 'Ukończono w {duration}',
  'chat.toolPart.unifiedExec.outputTruncated': 'Pominięto wcześniejsze dane wyjściowe',
  'chat.toolPart.unifiedExec.outputStreamError': 'Błąd strumienia wyjściowego: {error}',
  'chat.assistantStatus.unifiedExec.runningCommand': 'wykonywanie polecenia',
  'chat.assistantStatus.unifiedExec.preparingProcessOperation': 'przygotowywanie operacji procesu',
  'chat.assistantStatus.unifiedExec.pollingProcessOutput': 'sprawdzanie danych wyjściowych procesu',
  'chat.assistantStatus.unifiedExec.sendingProcessInput': 'wysyłanie danych do procesu',
  'chat.assistantStatus.unifiedExec.terminatingProcess': 'kończenie procesu',
  'chat.providerError.rateLimited': 'Ten model ma ograniczenie szybkości. OpenCode spróbuje ponownie, gdy będzie dostępna przepustowość.',
  'chat.providerError.usageLimited': 'Osiągnięto limit użycia tego modelu. Wybierz inny model, aby kontynuować.',
  'chat.providerError.planNotIncluded': 'Twój obecny plan nie obejmuje tego modelu. Wybierz inny model lub uaktualnij plan.',
  'chat.providerError.quotaExceeded': 'Limit został wyczerpany. Sprawdź plan i rozliczenia.',
  'chat.providerError.policyBlocked': 'To żądanie zostało zablokowane przez zasady bezpieczeństwa. Zmień je i spróbuj ponownie.',
  'chat.providerError.authentication': 'Uwierzytelnianie nie powiodło się. Zaloguj się ponownie lub sprawdź poświadczenia dostawcy.',
  'chat.providerError.invalidInput': 'Nie można było przetworzyć tego żądania. Dostosuj je i spróbuj ponownie.',
  'chat.providerError.network': 'Żądanie do dostawcy zostało zablokowane przez sieć lub region. Sprawdź połączenie i dostęp do dostawcy.',
  'chat.providerError.server': 'Dostawca jest tymczasowo niedostępny. OpenCode automatycznie spróbuje ponownie.',
} as const;
