...
export const dict = {
  ...
  'chat.liveActivity.runningCommands': 'Commandes en cours : {count}',
  ...
  'startup.launching': 'Démarrage d’OpenChamber',
  'startup.migrating': 'Mise à niveau de la base de données',
  'startup.finalizing': 'Migration terminée, en attente de la disponibilité d’OpenCode',
  'startup.migrationDetail': 'Cela peut prendre plusieurs minutes. Gardez OpenChamber ouvert.',
  'startup.failed': 'Impossible de démarrer OpenChamber',
  'startup.restartDetail': 'Redémarrez OpenChamber pour réessayer.',
  ...
  'chat.activity.exploration': 'Exploration',
  'chat.activity.exploration.summary.searchesAndReads': 'Recherches : {searchCount} · Lectures : {readCount}',
  'chat.activity.exploration.summary.searches': 'Recherches : {searchCount}',
  'chat.activity.exploration.summary.reads': 'Lectures : {readCount}',
  ...
  'chat.toolPart.readDirectory': 'Lire le répertoire',
  ...
  'chat.toolPart.unifiedExec.status.running': 'En cours',
  'chat.toolPart.unifiedExec.status.runningWithDuration': 'En cours depuis {duration}',
  'chat.toolPart.unifiedExec.status.terminated': 'Arrêté',
  'chat.toolPart.unifiedExec.status.terminatedWithDuration': 'Arrêté · {duration}',
  'chat.toolPart.unifiedExec.status.exited': 'Terminé avec le code {code}',
  'chat.toolPart.unifiedExec.status.exitedWithDuration': 'Terminé avec le code {code} · {duration}',
  'chat.toolPart.unifiedExec.status.completed': 'Terminé',
  'chat.toolPart.unifiedExec.status.completedWithDuration': 'Terminé en {duration}',
  'chat.toolPart.unifiedExec.outputTruncated': 'Sortie précédente omise',
  'chat.toolPart.unifiedExec.outputStreamError': 'Erreur du flux de sortie : {error}',
  'chat.assistantStatus.unifiedExec.runningCommand': 'exécution de la commande',
  'chat.assistantStatus.unifiedExec.preparingProcessOperation': 'préparation de l’opération du processus',
