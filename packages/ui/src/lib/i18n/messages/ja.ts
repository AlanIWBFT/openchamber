...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.liveActivity.runningCommands': '実行中のコマンド：{count}',
  ...
  'startup.launching': 'OpenChamber を起動しています',
  'startup.migrating': 'データベースをアップグレードしています',
  'startup.finalizing': '移行が完了しました。OpenCode の準備が整うまでお待ちください',
  'startup.migrationDetail': '数分かかる場合があります。OpenChamber を開いたままにしてください。',
  'startup.failed': 'OpenChamber を起動できませんでした',
  'startup.restartDetail': 'OpenChamber を再起動して、もう一度お試しください。',
  ...
  'chat.activity.exploration': '探索',
  'chat.activity.exploration.summary.searchesAndReads': '検索 {searchCount}回 · 読み取り {readCount}回',
  'chat.activity.exploration.summary.searches': '検索 {searchCount}回',
  'chat.activity.exploration.summary.reads': '読み取り {readCount}回',
  ...
  'chat.toolPart.readDirectory': 'ディレクトリを読み取る',
  ...
  'chat.toolPart.unifiedExec.status.running': '実行中',
  'chat.toolPart.unifiedExec.status.runningWithDuration': '実行中 {duration}',
  'chat.toolPart.unifiedExec.status.terminated': '強制終了',
  'chat.toolPart.unifiedExec.status.terminatedWithDuration': '強制終了 · {duration}',
  'chat.toolPart.unifiedExec.status.exited': '終了コード {code}',
  'chat.toolPart.unifiedExec.status.exitedWithDuration': '終了コード {code} · {duration}',
  'chat.toolPart.unifiedExec.status.completed': '完了',
  'chat.toolPart.unifiedExec.status.completedWithDuration': '完了 · {duration}',
  'chat.toolPart.unifiedExec.outputTruncated': '以前の出力は省略されました',
  'chat.toolPart.unifiedExec.outputStreamError': '出力ストリームエラー：{error}',
  'chat.assistantStatus.unifiedExec.runningCommand': 'コマンドを実行中',
  'chat.assistantStatus.unifiedExec.preparingProcessOperation': 'プロセス操作を準備中',
  'chat.assistantStatus.unifiedExec.pollingProcessOutput': 'プロセス出力を確認中',
  'chat.assistantStatus.unifiedExec.sendingProcessInput': 'プロセス入力を送信中',
  'chat.assistantStatus.unifiedExec.terminatingProcess': 'プロセスを終了中',
  'chat.providerError.rateLimited': 'このモデルにはレート制限があります。容量が利用可能になり次第、OpenCode が再試行します。',
  'chat.providerError.usageLimited': 'このモデルの利用上限に達しました。続行するには別のモデルを選択してください。',
  'chat.providerError.planNotIncluded': '現在のプランではこのモデルを利用できません。別のモデルを選択するか、プランをアップグレードしてください。',
  'chat.providerError.quotaExceeded': 'クォータを使い切りました。プランと請求を確認してください。',
  'chat.providerError.policyBlocked': 'このリクエストは安全ポリシーによりブロックされました。内容を変更して再試行してください。',
  'chat.providerError.authentication': '認証に失敗しました。再度サインインするか、プロバイダーの認証情報を確認してください。',
  'chat.providerError.invalidInput': 'このリクエストは処理できませんでした。内容を調整して再試行してください。',
  'chat.providerError.network': 'プロバイダーへのリクエストはネットワークまたは地域によりブロックされました。接続とプロバイダーへのアクセスを確認してください。',
  'chat.providerError.server': 'プロバイダーは一時的に利用できません。OpenCode が自動的に再試行します。',
