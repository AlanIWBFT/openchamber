...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.liveActivity.runningCommands': '正在运行的命令：{count}',
  ...
  'startup.launching': '正在启动 OpenChamber',
  'startup.migrating': '正在升级数据库',
  'startup.finalizing': '迁移完成，正在等待 OpenCode 就绪',
  'startup.migrationDetail': '这可能需要几分钟，请保持 OpenChamber 开启。',
  'startup.failed': 'OpenChamber 启动失败',
  'startup.restartDetail': '请重启 OpenChamber 后重试。',
  ...
  'chat.activity.exploration.summary.searchesAndReads': '{searchCount} 次搜索 · {readCount} 次读取',
  'chat.activity.exploration.summary.searches': '{searchCount} 次搜索',
  'chat.activity.exploration.summary.reads': '{readCount} 次读取',
  ...
  'chat.toolPart.readDirectory': '读取目录',
  ...
  'chat.toolPart.unifiedExec.status.running': '正在运行',
  'chat.toolPart.unifiedExec.status.runningWithDuration': '已运行 {duration}',
  'chat.toolPart.unifiedExec.status.terminated': '已终止',
  'chat.toolPart.unifiedExec.status.terminatedWithDuration': '已终止 · {duration}',
  'chat.toolPart.unifiedExec.status.exited': '已退出，代码 {code}',
  'chat.toolPart.unifiedExec.status.exitedWithDuration': '已退出，代码 {code} · {duration}',
  'chat.toolPart.unifiedExec.status.completed': '已完成',
  'chat.toolPart.unifiedExec.status.completedWithDuration': '已完成 · {duration}',
  'chat.toolPart.unifiedExec.outputTruncated': '已省略较早的输出',
  'chat.toolPart.unifiedExec.outputStreamError': '输出流错误：{error}',
  'chat.assistantStatus.unifiedExec.runningCommand': '正在运行命令',
  'chat.assistantStatus.unifiedExec.preparingProcessOperation': '正在准备进程操作',
