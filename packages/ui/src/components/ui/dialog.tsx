    ...
    <DialogPortal>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none p-4">
        <BaseDialog.Popup
          ...
          className={cn(
            "relative pointer-events-auto bg-surface-elevated text-surface-elevated-foreground flex flex-col w-full max-w-lg max-h-full gap-4 rounded-xl border p-6 shadow-none overflow-y-auto pwa-dialog-content origin-center",
