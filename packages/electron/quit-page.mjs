...
const STARTUP_FAILURE_COPY = {
  en: { title: 'OpenChamber could not start', detail: 'Restart OpenChamber to try again.' },
  fr: { title: 'Impossible de démarrer OpenChamber', detail: 'Redémarrez OpenChamber pour réessayer.' },
  'zh-CN': { title: 'OpenChamber 启动失败', detail: '请重启 OpenChamber 后重试。' },
  'zh-TW': { title: 'OpenChamber 啟動失敗', detail: '請重新啟動 OpenChamber 後再試。' },
  uk: { title: 'Не вдалося запустити OpenChamber', detail: 'Перезапустіть OpenChamber, щоб спробувати ще раз.' },
  es: { title: 'No se pudo iniciar OpenChamber', detail: 'Reinicia OpenChamber para volver a intentarlo.' },
  'pt-BR': { title: 'Não foi possível iniciar o OpenChamber', detail: 'Reinicie o OpenChamber para tentar novamente.' },
  ko: { title: 'OpenChamber를 시작할 수 없습니다', detail: 'OpenChamber를 다시 시작한 후 재시도하세요.' },
  pl: { title: 'Nie udało się uruchomić OpenChamber', detail: 'Uruchom ponownie OpenChamber, aby spróbować jeszcze raz.' },
  ja: { title: 'OpenChamber を起動できませんでした', detail: 'OpenChamber を再起動して、もう一度お試しください。' },
};
